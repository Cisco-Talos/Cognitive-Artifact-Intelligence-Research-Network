...
The `CAIRN` maintainers take all security issues in the project
seriously. Thank you for improving the security of `CAIRN`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`CAIRN` leverages GitHub's private vulnerability reporting.
